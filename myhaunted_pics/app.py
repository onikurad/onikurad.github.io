...
def enter_forest():
    ...
    return render_template('bonfire.html', title=title, text=text, choices=choices)
...
def bonfire():
    ...
    return render_template('forestdone.html', title=title, text=text, choices=choices)
...
def run_away():
    ...
    return render_template('leave.html', title=title, text=text, choices=choices)
